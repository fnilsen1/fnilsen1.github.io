...
file1 = r"Python\motorlab\csv-testfiler\Hastighet_PI_maaling.csv"
...
# Enkel lagring
# save_tikz(r'csv-testfiler\filNavn.tex') #Merk: denne funker ikke om dere bruker plt.show() i scriptet
